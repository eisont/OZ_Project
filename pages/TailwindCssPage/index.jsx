...
const TailwindCssPage = () => {
  ...
  return (
    <div className=' w-130 flex flex-col justify-center items-center   '>
      <div className='flex w-full py-3 justify-around items-center '>
        <button className='border cursor-pointer hover:bg-gray-300 rounded-lg px-3 py-1 ' onClick={() => setCount((pr) => pr - 1)}>
          - 1
        </button>
        <button className='border cursor-pointer hover:bg-gray-300 rounded-lg px-3 py-1' onClick={() => setCount((pr) => pr - 10)}>
          - 10
        </button>
        <button className='border cursor-pointer hover:bg-gray-300 rounded-lg px-3 py-1' onClick={() => setCount((pr) => pr - 100)}>
          - 100
        </button>
        <button className='border cursor-pointer hover:bg-gray-300 rounded-lg px-3 py-1' onClick={() => setCount((pr) => pr + 1)}>
          + 1
